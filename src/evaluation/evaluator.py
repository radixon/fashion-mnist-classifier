...
class ModelEvaluator:
    ...
    def evaluate_model_performance(self, true_labels: List[int],
        ...
        # Store Metrics
        metrics = {"overall_accuracy": overall_accuracy, "classification_report_dict": report_dict,
                   "classification_report_str": report_str, "confusion_matrix": confusion_matrix_.tolist()}
...
def save_classification_report_txt(report_str: str, save_path: str) -> None:
    """
